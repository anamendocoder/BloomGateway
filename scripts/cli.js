...
const contractABI = require("../artifacts/contracts/Bloomgateway.sol/Bloomgateway.json").abi;

program
    .name("bloomgateway-cli")
    .description("CLI tool for Bloomgateway smart contract")
    .version("1.0.0");
