 ...
 * This file demonstrates how to integrate Bloomgateway with a web frontend
 */

// For React/Vue/Angular applications
export class BloomgatewayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BloomgatewayClient(provider, contractAddress);
